...
export default function HomeScreen() {
  ...
  // Canlı bildirim durumunu simüle eden state (Test etmek için içine geçici veri koyabilirsin kanka)
    ...
    <View style={styles.container}>
      ...
      <ScrollView 
        ...
        contentContainerStyle={[
          ...
          { paddingHorizontal: isMobile ? 15 : 40 } // Masaüstünde daha geniş padding ile ferah görünüm
        ]}
      >
        ...
        {activeAlert ? (
          ...
          <View style={[styles.statusCard, styles.safeCard, !isMobile && styles.desktopCardWidth]}>
            ...
            <Text style={styles.safeText}>
              Şu an bildirilen herhangi bir kayıp durumu bulunmuyor. Tüm etiketleriniz güvende.
            </Text>
          </View>
        )}
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  // Masaüstünde kartın devasa yayılmasını engellemek için maksimum genişlik sınırı
  desktopCardWidth: {
    maxWidth: 600,
